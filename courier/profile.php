...
<body class="bg-transparent text-dark">
    <div class="container-fluid bg-transparent text-dark">   
        <div class="row">
            <div class="col-12">
                <h3 class="display text-center mt-5 mb-4">
                    COURIER PROFILE
                </h3>
            </div>
            <div class="col-3"></div>
                <div class="col-md-6">          
                    <div class="card">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h6><strong>Name: </strong><?php echo $_SESSION['user']['firstname'] . " " . $_SESSION['user']['lastname']; ?></h6>
                            </div>
                            ...
                            <div class="col-12 mt-3">
                                <h6><strong>Contact Number: </strong><?php echo $_SESSION['user']['contact_number']; ?></h6>
                            </div>
                            <div class="col-12 mt-3">
